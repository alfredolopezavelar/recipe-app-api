...
class PrivateRecipeApiTest(TestCase):
    ...
    def test_recipe_list_limited_to_user(self):
        ...
        other_user = create_user(email='test2@example.com', password='pass2example')
    ...
    def test_full_update(self):
        ...
        payload = {
            ...
            'link': 'http://example/new-recipe.pdf',
    ...
    def test_update_user_returns_error(self):
        """Test changing the user"""
        new_user = create_user(email='example2@email.com', password="pass12234")
        recipe = create_recipe(user=self.user)
